...
class SpleenDataPreprocessor:
    ...
    def visualize_preprocessing(self, idx=0):
        ...
        plt.savefig(results_dir / f'preprocessing_example_{idx}.png', dpi=150, bbox_inches='tight')
        plt.show()
    ...
    def prepare_training_data(self, output_dir=None):
        """Prepare and save preprocessed training data"""
        output_path = Path(output_dir) if output_dir else (config.DATA_ROOT.parent / "preprocessed")
